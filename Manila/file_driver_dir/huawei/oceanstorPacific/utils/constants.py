...
ERROR_SPECIAL_STATUS = (
    ...
    33764381   # System resources are in use.
)
...
CASE_SENSITIVE = True
ENABLE_DPC = True
ENABLE_UPDATE_ATIME = True
ACL_POLICY_MIXED = 0
ACL_POLICY_UNIX = 1
ACL_POLICY_NTFS = 2
ACL_POLICY_NATIVE = 3
ACL_POLICY = [
    ACL_POLICY_MIXED, ACL_POLICY_UNIX, ACL_POLICY_NTFS, ACL_POLICY_NATIVE
]

# snapshot constants
SNAPSHOT_NORMAL_STATUS = "1"
SNAPSHOT_ROLLBACKING_STATUS = "2"
SNAPSHOT_ACTION = "rollback"
SNAPSHOT_ROLLBACK_WAIT_INTERVAL = 5
...
POWER_BETWEEN_BYTE_AND_KB = 1
POWER_BETWEEN_GB_AND_TB = 1
...
QOS_UNLIMITED = 0
QOS_KEYS = ["maxIOPS", "maxMBPS", "total_iops_sec", "total_ops_sec", "total_bytes_sec"]
QOS_MUST_SET = ["max_iops", "max_mbps"]
...
PLUGIN_DME_FILESYSTEM_IMPL = "PLUGIN_DME_FILESYSTEM_IMPL"
PLUGIN_ZTE_PLATFORM_IMPL = "PLUGIN_ZTE_PLATFORM_IMPL"
PRODUCT_PACIFIC = 'Pacific'
PRODUCT_PACIFIC_GFS = 'Pacific_GFS'
PRODUCT_DME_FILESYSTEM = 'DME_FILESYSTEM'
PLATFORM_ZTE = 'ZTE'
TIER_POOL_TYPE = 'NFS_HDD&DPC_SSD'
POOL_TYPE_LIST = ['NFS_SSD', 'NFS_HDD', 'DPC_SSD']
HDD_POOL_PRIORITY = ['NFS']
SSD_POOL_PRIORITY = ['DPC', 'NFS']
SUYAN_PRODUCT_IMPL_MAPPING = {
    PRODUCT_PACIFIC: PLUGIN_SUYAN_SINGLE_IMPL,
    PRODUCT_PACIFIC_GFS: PLUGIN_SUYAN_GFS_IMPL,
    PRODUCT_DME_FILESYSTEM: PLUGIN_DME_FILESYSTEM_IMPL,
}
PLATFORM_IMPL_MAPPING = {
    PLATFORM_ZTE: PLUGIN_ZTE_PLATFORM_IMPL
}
VALID_PRODUCTS = [PRODUCT_PACIFIC, PRODUCT_PACIFIC_GFS, PRODUCT_DME_FILESYSTEM]
DEFAULT_RESERVED_PERCENT = 15
DEFAULT_PACIFIC_SEMAPHORE = 20
...
CAPACITY_DATA_FILE_NAME = 'capacity_data_file.zip'
HUAWEI_TEMP_FILE_DIC = 'huawei_temp_file'
NAMESPACE_DATA_FILE_PREFIX = '57356_'
DTREE_DATA_FILE_PREFIX = '16445_'
MAX_CAPACITY_DATA_FILE_NUM = 2
MAX_CAPACITY_DATA_PER_FILE_SIZE = 1024 ** 2 * 500

# Capacity num
TOTAL_SPACE_USED_METRIC_NUM = '90065'
SSD_SPACE_USED_METRIC_NUM = '90064'
HDD_SPACE_USED_METRIC_NUM = '90062'
SSD_HARD_QUOTA_METRIC_NUM = '90061'
HDD_HARD_QUOTA_METRIC_NUM = '90059'
TOTAL_HARD_QUOTA_METRIC_NUM = '90058'
ALL_CAPACITY_METRIC_NUM = [
    TOTAL_SPACE_USED_METRIC_NUM, SSD_SPACE_USED_METRIC_NUM, HDD_SPACE_USED_METRIC_NUM,
    SSD_HARD_QUOTA_METRIC_NUM, HDD_HARD_QUOTA_METRIC_NUM, TOTAL_HARD_QUOTA_METRIC_NUM
]
...
# DME constants
# DME client config
DME_DEFAULT_NFS_CHARSET = 'utf-8'
DME_DEFAULT_DPC_CHARSET = 'UTF_8'
DME_DEFAULT_DPC_PERMISSION = 'read_and_write'
DME_DEFAULT_SECURITY_MODE = 'unix'
DME_DEFAULT_MAX_IOPS = 100
DME_DEFAULT_MAX_BAND_WIDTH = 1
DME_QUERY_INTERVAL_SECONDS = 0.5
DME_SOCKET_TIMEOUT = 32
DME_DEFAULT_SEMAPHORE = 10
...
DME_DATA_COUNT_ONE = 1
DME_SSD_TOTAL_CAP_KEY = 'ssd_total_capacity'
DME_SAS_TOTAL_CAP_KEY = 'sas_total_capacity'
DME_SATA_TOTAL_CAP_KEY = 'sata_total_capacity'
DME_SSD_USED_CAP_KEY = 'ssd_used_capacity'
DME_SAS_USED_CAP_KEY = 'sas_used_capacity'
DME_SATA_USED_CAP_KEY = 'sata_used_capacity'
DME_TOTAL_CAPACITY_ENUM = {
    DISK_TYPE_SSD: DME_SSD_TOTAL_CAP_KEY,
    DISK_TYPE_SAS: DME_SAS_TOTAL_CAP_KEY,
    DISK_TYPE_SATA: DME_SATA_TOTAL_CAP_KEY
}
DME_USED_CAPACITY_ENUM = {
    DISK_TYPE_SSD: DME_SSD_USED_CAP_KEY,
    DISK_TYPE_SAS: DME_SAS_USED_CAP_KEY,
    DISK_TYPE_SATA: DME_SATA_USED_CAP_KEY
}
...
FILESYSTEM_NOT_EXIST = (OBJECT_NOT_EXIST, )
DME_DTREE_NOT_EXIST = (OBJECT_NOT_EXIST, )
DME_QUOTA_NOT_EXIST = (OBJECT_NOT_EXIST, )

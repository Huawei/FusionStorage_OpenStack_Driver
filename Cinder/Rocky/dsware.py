...
volume_opts = [
    ...
    cfg.StrOpt('user_name',
               default='',
               help='The user name of the FusionStorage array. Such as '
                    '"user_name=xxx"'),
    cfg.StrOpt('password',
               default='This field is configured with the password of '
                       'FusionStorage array. For example, "password=xxx"',
               secret=True,
               help=''),
